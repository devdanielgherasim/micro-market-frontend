...
// Default filter to show recent activity
    ...
    <AdminRoute fallback={
      <div className="py-6 sm:py-8 lg:py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-2xl font-bold text-secondary-900 dark:text-white sm:text-3xl mb-4">Access Denied</h1>
      ...
      <div className="py-6 sm:py-8 lg:py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="sm:flex sm:items-center sm:justify-between mb-6">
            <div>
              <h1 className="text-2xl font-bold text-secondary-900 dark:text-white sm:text-3xl">Audit Logs</h1>
