...
export const ClientDashboard: React.FC = () => {
  ...
  // Group orders by product ID to show total quantity and latest expiration
    ...
    <div className="space-y-6">
      ...
      {loading ? (
        <div className="flex justify-center items-center py-8">
          <div className="animate-spin rounded-full h-10 w-10 border-2 border-primary-500 dark:border-primary-400 border-t-transparent shadow-md"></div>
        </div>
      ) : orders.length > 0 ? (
        <div className="bg-white dark:bg-secondary-800 rounded-lg shadow-sm overflow-hidden border border-secondary-200 dark:border-secondary-700">
          <div className="px-4 py-5 sm:px-6 border-b border-secondary-200 dark:border-secondary-700">
            <h3 className="text-lg font-medium text-secondary-900 dark:text-white">Your Purchased Products</h3>
        ...
        <div className="text-center py-8 text-sm text-secondary-500 dark:text-secondary-400 bg-secondary-50 dark:bg-secondary-800/50 rounded-lg shadow-sm p-6">
