...
const OrderItem: React.FC<OrderItemProps> = ({ order }) => {
  ...
  return (
    <div className="bg-white dark:bg-secondary-800 rounded-lg shadow-sm overflow-hidden border border-secondary-200 dark:border-secondary-700">
      <div className="px-4 py-5 sm:px-6 flex justify-between items-center border-b border-secondary-200 dark:border-secondary-700">
        <div>
      ...
      <div className="px-4 py-4 sm:px-6 flex justify-between items-center">
        ...
        <button className="px-4 py-2 bg-primary-50 hover:bg-primary-100 text-primary-700 dark:bg-primary-900/10 dark:hover:bg-primary-900/20 dark:text-primary-400 rounded-md transition-colors focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 dark:focus:ring-offset-secondary-900 text-sm font-medium">
          View Details
        </button>
      </div>
    </div>
