        ...
        <div className="container mx-auto px-4 sm:px-6 flex items-center justify-between h-16 sm:h-18 md:h-20">
            <div className="flex items-center">
                ...
                <div className="flex items-center flex-shrink-0 ml-2 sm:ml-4 lg:ml-0">
                    <div
                        className="flex items-center justify-center w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-br from-primary-500 to-primary-700 rounded-xl shadow-glow dark:shadow-primary-500/20">
                        <svg className="h-5 w-5 sm:h-6 sm:w-6 text-white" fill="none" stroke="currentColor"
                             viewBox="0 0 24 24">
            ...
            <span
                className="bg-clip-text text-transparent bg-gradient-to-r from-primary-600 to-primary-500 dark:from-primary-400 dark:to-primary-300">
              Micro
            </span>
                        <span>Market</span>
                    </h1>
            ...
            <div className="flex items-center space-x-3 sm:space-x-4">
                ...
                <div className="relative">
                    ...
                    >
                        <div
                            className="h-7 w-7 sm:h-8 sm:w-8 md:h-9 md:w-9 rounded-full flex items-center justify-center text-white font-medium bg-gradient-to-br from-primary-400/50 to-primary-600/50 shadow-inner overflow-hidden">
        ...
        >
            <div className="absolute top-4 right-4 z-10">
                ...
                >
                    ...
                    <svg className="h-5 w-5 text-secondary-500 dark:text-secondary-300" fill="none" viewBox="0 0 24 24"
                         stroke="currentColor">
...
const Footer: React.FC = () => (
    <footer
        className="bg-white/90 dark:bg-secondary-900/90 backdrop-blur-sm border-t border-secondary-200/70 dark:border-secondary-800/30 mt-auto">
        <div className="container mx-auto py-3 sm:py-4 md:py-5 px-4 sm:px-6">
            <div className="flex flex-col sm:flex-row items-center justify-between">
                <p className="text-center text-sm text-secondary-500 dark:text-secondary-400">
                    ...
                    <span className="text-primary-600 dark:text-primary-400 font-medium">Micro Market</span>. All rights
                    reserved.
                </p>
