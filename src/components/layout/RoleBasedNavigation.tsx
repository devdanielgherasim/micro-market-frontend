...
import { AdminOnly, ClientOnly, AuthenticatedOnly, GuestOnly } from '@/components/auth/RoleBasedAccess';
...
const NavItem: React.FC<NavItemProps> = ({ href, icon, label, isActive = false, onClick }) => {
  ...
  return (
    <Link 
      ...
      onClick={onClick}
    >
      <span className={`flex items-center transition-transform duration-200 ${isActive ? 'text-primary-600 dark:text-primary-400' : 'text-secondary-500 dark:text-secondary-400 group-hover:text-primary-500 dark:group-hover:text-primary-400'}`}>
        {icon}
  ...
  return (
    <nav className="flex flex-col space-y-1.5 w-full">
      ...
      {isAuthenticated ? (
        ...
        >
          <span className="flex items-center text-secondary-500 dark:text-secondary-400 group-hover:text-danger-500 dark:group-hover:text-danger-400">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <GuestOnly>
          ...
          >
            <span className="flex items-center text-secondary-500 dark:text-secondary-400 group-hover:text-primary-500 dark:group-hover:text-primary-400">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
